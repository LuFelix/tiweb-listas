...
//	private List<Ativo> listAtvSis;
	...
	// TODO +++++Construtor da Tela de Operacaos+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		lblTituloTela = new JLabel("Produtos:"); lblTituloTela.setBounds(10, 10, 120, 20); lblTituloTela.setFont(new Font("Times new roman", Font.BOLD, 16));
		...
		arvoreSistema = new JTree(modArvore);arvoreSistema.setBounds(5, 5, 225, 440);
		...
		//+++ Jbuttons+++++++++++++++++++++++
		btnAnterior = new JButton("<<<<");   	btnAnterior.setBounds(10, 495, 85, 25);
		btnProximo = new JButton(">>>>");    	btnProximo.setBounds(95, 495, 85, 25);
		btnAdiciona = new JButton("Add");      btnAdiciona.setBounds(10, 520, 85, 25);
		btnSalvar = new JButton("Salva");      btnSalvar.setBounds(95, 520, 85, 25);
		btnRemove = new JButton("Rem");    btnRemove.setBounds(10, 545, 85, 25);
		btnMinerar = new JButton("Minerar");  btnMinerar.setBounds(95, 545, 85, 25);
		
		//TODO +++++ A�oes dos Botoes+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//					}
		...
		//TODO +++++A��es de foco dos Text Fields++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//					FrameInicial.setTblPapeis(montaGrid.montaTabelaCotacao(col, atv.getListCot()));
